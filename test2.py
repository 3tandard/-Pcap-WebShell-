...
def extract_http_requests(pcap_file):
    ...
    for packet in cap:
        try:
            ...
            post_data = getattr(http_layer, "file_data", "No POST Data") if method == "POST" else "N/A"
            ...
            if user_agent in WEEVELY_USER_AGENTS:
                print("[⚠️] Detected potential Weevely WebShell traffic!")
